...
namespace LogisticSolutions.Models
{
    public class AddDeliveryViewModel
    {
        ...
        [StringLengthAttribute(100, MinimumLength = 0, ErrorMessage = "{0}: wprowadź pomiędzy {2} a {1} znaków!")]
        public string Content { get; set; }

        [Display(Name = "Dodatkowe informacje")]
        [StringLengthAttribute(200, MinimumLength = 0, ErrorMessage = "{0}: wprowadź pomiędzy {2} a {1} znaków!")]
        ...
        [Required(ErrorMessage = "Uzupełnienie pola {0} jest wymagane!")]
        [StringLengthAttribute(50, MinimumLength = 9, ErrorMessage = "{0}: wprowadź pomiędzy {2} a {1} znaków!")]
        public string PickupAddressName { get; set; }

        [Display(Name = "Telefon")]
        [Required(ErrorMessage = "Uzupełnienie pola {0} jest wymagane!")]
        [StringLengthAttribute(20, MinimumLength = 9, ErrorMessage = "{0}: wprowadź pomiędzy {2} a {1} znaków!")]
        public string PickupAddressPhone { get; set; }

        [Display(Name = "Email")]
        [EmailAddress(ErrorMessage = "Wprowadź poprawny adres email!")]
        [Required(ErrorMessage = "Uzupełnienie pola {0} jest wymagane!")]
        [StringLengthAttribute(50, MinimumLength = 5, ErrorMessage = "{0}: wprowadź pomiędzy {2} a {1} znaków!")]
        ...
        [Display(Name = "Adres")]
        [Required(ErrorMessage = "Uzupełnienie pola {0} jest wymagane!")]
        [StringLengthAttribute(20, MinimumLength = 5, ErrorMessage = "{0}: wprowadź pomiędzy {2} a {1} znaków!")]
        public string PickupAddressAddressLine1 { get; set; }

        [Display(Name = "Adres cd.")]
        [StringLengthAttribute(20, MinimumLength = 0, ErrorMessage = "{0}: wprowadź pomiędzy {2} a {1} znaków!")]
        ...
        [Required(ErrorMessage = "Uzupełnienie pola {0} jest wymagane!")]
        [StringLengthAttribute(6, MinimumLength = 6, ErrorMessage = "{0}: wprowadź pomiędzy {2} a {1} znaków!")]
        public string PickupAddressPostalCode { get; set; }

        [Display(Name = "Miasto")]
        [Required(ErrorMessage = "Uzupełnienie pola {0} jest wymagane!")]
        [StringLengthAttribute(30, MinimumLength = 1, ErrorMessage = "{0}: wprowadź pomiędzy {2} a {1} znaków!")]
